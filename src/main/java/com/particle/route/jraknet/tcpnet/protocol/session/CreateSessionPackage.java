...
public class CreateSessionPackage extends RakNetPacket implements Failable {
    ...
    public CreateSessionPackage(Packet packet) {
        super(packet);
    }

    public CreateSessionPackage() {
        super(TcpMessageIdentifier.TCP_NEW_SESSION);
    }
